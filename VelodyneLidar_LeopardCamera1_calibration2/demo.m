...
pcd_folder = "./data/pcd";
transformMatrix_path = "./VelodyneLidar_LeopardCamera1_TF.mat";
intrinsicsMatrix_path = "./LeopardCamera1_oringin.mat";
WAITKEY_ON = 1;
...
for i = 1:num_samples
    ...
    image = undistortImage(image, cameraParams); % 图像需要去畸变
    pcd = pcread(pcd_path);
